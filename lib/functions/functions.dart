...
//base url
String url =
    'https://panel.taxibaxi.com/'; //add '/' at the end of the url as 'https://url.com/'
String mapkey =
    (platform == TargetPlatform.android) ? 'AIzaSyCPrD5rs_eANrt7sLI8iGotnpG97Vcbdsk' : 'ios map key';
...
etaRequest({transport, outstation}) async {
  ...
  try {
    print("url: "'${url}api/v1/request/eta');
    print('Authorization: Bearer ${bearerToken[0].token}');
    print('body: Bearer ${demo}');
